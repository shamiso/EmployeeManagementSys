...
namespace EmployeeManagementSys.Controllers
{
    public class DesignationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Code,ActivityId,CreatedById,CreatedOn,ModifiedById,ModifiedOn")] Designation designation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Code,ActivityId,CreatedById,CreatedOn,ModifiedById,ModifiedOn")] Designation designation)
        {
